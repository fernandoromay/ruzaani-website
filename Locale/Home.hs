...
locale EN = HomeLocale
    ...
    , heroCtaMainLink = accessPath EN
    , heroCtaAgency = "Discover Agencies Program"
    , heroCtaAgencyLink = agencyPath EN
    , statBar =
...
locale ES = HomeLocale
    ...
    , heroCtaMainLink = accessPath ES
    , heroCtaAgency = "Programa para Agencias"
    , heroCtaAgencyLink = agencyPath ES
    , statBar =
    ...
    , replaceItems =
        ...
        , Point
            ...
            , description = "Más allá del almacenamiento. Cada señal de intención, progresión de puntaje e interacción de agente se graba en un Golden Record que evoluiona en tiempo real."
            }
        ]
    ...
    , enterpriseItems =
        [ Point
            { title = "Puntuación Predictiva de Leads"
            , description = "El Analista cruza los rastros de comportamiento con datos históricos de conversión para predecir churn y señalar inmediatamente cuentas de alto valor."
            }
        , Point
            { title = "Memoria Contextual"
            , description = "Cada interacción, desde un clic en un anuncio B2B rastreado hasta una consulta por correo electrónico, se contextualiza instantáneamente para los agentes SDR y Closer."
            }
        , Point
            { title = "RevOps Automatizado"
            , description = "El Estratega audita continuamente la velocidad de tu pipeline, identificando cuellos de botella en la conversación y fugas en la campaña en tiempo real."
            }
        , Point
            { title = "Previsión de Ingresos"
            , description = "Los agentes de IA modelan tu pipeline actual contra datos históricos de conversión y señales de comportamiento para generar una proyección de ingresos en tiempo real."
            }
        ]
...
locale KO = HomeLocale
    ...
    , heroCtaMain = "액세스 요청"
    , heroCtaMainLink = accessPath KO
    , heroCtaAgency = "에이전시 프로그램 알아보기"
    , heroCtaAgencyLink = agencyPath KO
    , statBar =
